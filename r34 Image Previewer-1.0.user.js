...
(async function() {
    ...
    document.querySelector('#post-list > span').remove(); // Removes the right container
    document.querySelector('.image-list').style = 'width: 56dvw'; // Resizes the main container
    let con = document.createElement('div');
    con.style = 'width: stretch';
    document.querySelector('#post-list').appendChild(con); // Creates the preview container
